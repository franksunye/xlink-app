...
| 2 | 与第 4 轮流程文档对齐的节点/表单占位或只读展示 | 可对照 `business` 服务工单语义走通 UI 空壳；**范围**见 [13-v0.2-scope](./13-v0.2-scope.md) | [flows/](./flows/) 定稿后对齐；代码落点 **[web/](../web/)** — Adapter、只读节点区（见该目录 README / acceptance） |
...
| v0.2（POC 波次 2） | [13-v0.2-scope.md](./13-v0.2-scope.md)（已发布） | [10 §4](./10-release-and-acceptance.md#4-验收清单模板可发布版本)；手动脚本 [web/docs/acceptance-v0.2.md](../web/docs/acceptance-v0.2.md) |
