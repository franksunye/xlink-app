<template>
  <view class="pay">
    <block v-if="loaded">
      <block v-if="phone">
        <view class="top">
          <view class="c-flex c-item-center c-m-b-10">
            <image
              src="../../static/images/slogan-logo.png"
              mode="widthFix"
              style="width: 66px; height: 26px"
            ></image>
            <text class="c-m-l-20">防水维修服务</text>
          </view>
          <view
            style="color: #736e6e"
            ...
            :key="i"
          >
            <text>{{ order.constructionLocation }}</text>
        ...
        <view class="content">
          ...
          >
            ...
            <text>优惠券</text>
            <view
              style="min-width: 50px; text-align: right; color: red"
        ...
        <view class="c-uni-submit">
          ...
          <view>
            ...
            <text class="amount">
              ...
              <text class="number">{{ payStatus.currentPaymentAmount }}</text>
            </text>
          </view>
          <button
            class="c-uni-button round round warning"
            hover-class="hover"
            style="width: 110px; height: 40px !important"
            plain
            @click="pay"
          >
            支付
...
.pay {
  ...
  .top {
    ...
    .tag {
      ...
      flex-shrink: 0;
      border-radius: 80px;
      background: linear-gradient(266deg, #508af6 0%, #1a62f1 101.77%);
      color: #fff;
      text-align: center;
      font-family: Inter;
      font-size: 10px;
