          ...
          <block v-if="extField.state == 1">
            ...
            <block v-else-if="extField.type == 'button'">
              <block v-if="extField.name == 'button'">
                <view
                  class="c-flex"
                  style="justify-content: space-between; padding: 10rpx; background: #fff"
                >
                  <van-button @click="initiatingAgreement('0')" round type="info" plain>
                    线上签约
                  </van-button>
                  <van-button @click="initiatingAgreement('1')" round type="info" plain>
                    线下签约
                  </van-button>
                </view>
              </block>
            ...
            <block v-else-if="extField.type == 'textarea'">
              <view class="field-box-wrapper">
                ...
                <textarea
                  ...
                  class="textarea"
                  style="text-align: right; overflow-y: auto"
                  :data-extfield="extField"
                  :data-name="extField.name"
    ...
    >
      ...
      <van-cell-group>
        <view class="" style="padding: 20rpx">
          ...
          >
            <van-radio
              v-if="contractData.contractType == '1'"
              name="1"
              style="margin-bottom: 10rpx"
            >
              客户版
            </van-radio>
            <van-radio v-if="contractData.contractType == '1'" name="2">服务商垫资版</van-radio>
            <van-radio
              v-if="
                contractData.contractType == '7' ||
                contractData.contractType == '11' ||
                contractData.contractType == '21'
              "
              name="3"
            >
              退款说明
...
export default {
  data() {
    return {
      ...
      supplementTreatyType: '' //合同协议签署状态 1线下 0线上
    };
  },
  onShow() {
  ...
  methods: {
    ...
    initiatingAgreement(supplementTreatyType) {
      ...
      console.log(row, this.urlParams.row);
      if (this.urlParams.type == '2' && !this.refundMemoData.call) {
        ...
        if (row.paidAmount > row.adjustRefundMoney - this.formData.money) {
          ...
          this.supplementTreatyType = supplementTreatyType; //supplementTreatyType 1线下 0线上
          return;
        }
      }
      ...
      let params = { supplementTreatyType: this.supplementTreatyType }; //supplementTreatyType 1线下 0线上
    ...
    onClick(e) {
      ...
      if (type == 'date' || type == 'time' || type == 'datetime') {
        ...
        if (
          (this.contractData.contractType == '7' ||
            this.contractData.contractType == '11' ||
            this.contractData.contractType == '21') &&
          field == 'refundType'
        ) {
