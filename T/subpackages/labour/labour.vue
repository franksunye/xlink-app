  ...
  <view class="labour">
    ...
    <view class="info" v-if="formData._id">
      <view class="info-card">
        ...
        >
          <view class="c-flex c-item-center">
            <i class="iconfont icon-dianhua" style="color: #28ff42; margin-right: 4px"></i>
          ...
          <van-button round size="small" color="#0078D0" @click="makePhoneCall(formData.phone)">
            免费拨打
          </van-button>
      ...
      <view class="info-content">
        ...
        <view style="color: #333333; height: 25px; margin: 12px 0 5px; font-size: 14px">
