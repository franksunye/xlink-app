  ...
  <view>
    <view>
      <image
        mode="widthFix"
        style="width: 100vw"
        src="https://pub.fsgo365.cn/8227332145206637444.jpg"
      />
    </view>
    <view class="form">
    ...
    <view>
      <image
        mode="widthFix"
        style="width: 100vw"
        src="https://pub.fsgo365.cn/4200544293141957765.jpg"
      />
    </view>
    <!-- 上拉菜单 -->
    <van-action-sheet
...
export default {
  data() {
    return {
      ...
      mapKey: 'EBDBZ-KTS3Q-4P45T-4NTG6-VLTKT-BGB2T' //使用在腾讯位置服务申请的key
    };
  },
  onLoad(params) {
    this.init(params);
  ...
  methods: {
    init(params) {
      ...
      if (params.q || params.channel) {
        ...
        this.params = params;
        console.log(this.params, '扫码携带的参数params');
    ...
    async getTenantId(params) {
      ...
      if (tenantId == '1340835581184723420') {
        common.osg.ajax('basic/serviceTerritory/queryById/6261580647448264955', {}, res => {
    ...
    doSave() {
      ...
      // 3904066108544797157雨虹虚拟店铺 7735960217998541408修链虚拟店铺
