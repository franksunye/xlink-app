    ...
    <view
      ...
      @click="
        open('../message/message', {
          relationId: item._id,
          sendUserName: item.orgId == '1340835581184723420' ? '平台客服' : item.orgName
        })
      "
    >
      <view class="chat-item-left">
        <!-- <image class="chat-item-avatar" src="../../static/resources/images/headportrait.png" /> -->
        <van-icon
          name="https://pub.fsgo365.cn/kefu.png"
          :info="item.exts.newCount || ''"
          size="40px"
          style="background: #f9f9f9; border-radius: 50%"
        />
      </view>
      ...
      <view class="chat-item-right">
        <view class="chat-item-top">
          <text class="chat-item-name">
            {{ item.orgId == '1340835581184723420' ? '平台客服' : item.orgName }}
          </text>
