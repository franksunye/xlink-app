  ...
  <view class="messages">
    ...
    >
      <view class="chat-item-left">
        ...
        <van-icon
          v-else
          :name="item.sendUserAvatar || '../../static/images/kefu.png'"
          size="40px"
          style="background: #fff; border-radius: 50%; overflow: hidden"
        />
      </view>
...
export default {
  ...
  onLoad(params) {
    ...
    this.userId = wx.getStorageSync('_currentUser').user._id;
