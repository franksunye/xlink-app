  ...
  <view class="account">
        ...
        <view @click="select(item)" v-for="(item, i) in repairPartsData" :key="i" class="imgCard">
          ...
          <view style="padding: 0 8px 0px 8px; width: 100%; height: 23px">
            <image
              ...
              src="https://pub.fsgo365.cn/jishi/doCheck.png"
              mode="widthFix"
    ...
    <view class="block" v-if="page == 2">
      ...
      <view>
        ...
        <view v-if="data.repairParts.val == '6' || data.repairParts.val == '7'">
          <view>
            <uni-easyinput v-model="data.long" placeholder="请填写长度（单位：米）"></uni-easyinput>
          </view>
          <view class="c-m-t-10">
            <uni-easyinput v-model="data.wide" placeholder="请填写宽度（单位：米）"></uni-easyinput>
          </view>
        </view>
        <view></view>
      </view>
        ...
        >
          ...
          <view style="padding: 0 8px 0px 8px; width: 100%; height: 23px">
            <image
              ...
              src="https://pub.fsgo365.cn/jishi/doAdd.png"
              mode="widthFix"
              style="width: 28px; height: 20px"
            ></image>
            <image
          ...
          <view :class="doAgelimitData.windowType == '1' ? 'windowTypeBlock1' : 'windowTypeBlock2'">
            <view>
              <image
                ...
                src="https://pub.fsgo365.cn/jishi/youbaowen.png"
                mode="widthFix"
                style="width: 22px; height: 22px"
              ></image>
              <image
                v-if="doAgelimitData.windowType == '0'"
                src="https://pub.fsgo365.cn/jishi/wubaowen.png"
                mode="widthFix"
                style="width: 22px; height: 22px"
              ></image>
            </view>
        ...
        <view class="bg3Reason">
          ...
          <view style="width: 70%" class="card">
            ...
            <view style="display: flex; justify-content: flex-end; padding-top: 15px">
              <uni-icons type="location-filled" size="14px" color="#ff6900" />
              <!-- 城市 -->
              <view class="c-m-l-5">{{ codelabel('city', data.city) || '' }}</view>
            </view>
          </view>
        </view>
        <!-- 图片 -->
...
export default {
  ...
  methods: {
    ...
    doSaveData() {
      ...
      params.tenantId = '4670873342363649607'; //默认租户id
      params.state = 1;
      // 缓存渠道信息
