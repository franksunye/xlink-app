  ...
  <view class="declaration">
    <view>
      <image
        ...
        src="https://pub.fsgo365.cn/jishi/declarationBanner.png"
      />
    </view>

    <view class="form">
      <view class="c-size-20 c-bold c-m-b-20 c-text-center" style="margin-top: 20px">
        填写信息，免费上面勘察
      </view>
    ...
    <view>
      <view class="c-text-center c-size-10 c-color-value c-m-t-30 c-m-b-30">
        * 为了您的隐私及我们的声誉，您的信息将被严格保密，请放心填写
      </view>
      <image
        mode="widthFix"
        style="width: 100vw"
        src="https://pub.fsgo365.cn/jishi/introduction.png"
        class="c-flex"
      />
    </view>
    <!-- 成功提示 -->
    <uni-popup ref="upsertDialog" type="dialog">
      <view class="prompt-view">
        <view class="bell">
          <image src="https://pub.fsgo365.cn/jishi/bell.png" mode="widthFix" style="width: 24px" />
        </view>
        <view class="prompt-info-title">预约成功</view>
        <view class="prompt-info-desc">我们将会在30分钟内与您取得联系</view>
        <view class="prompt-info-desc">请您注意陌生来电</view>
