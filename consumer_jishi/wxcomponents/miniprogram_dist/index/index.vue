<template>
<uni-shadow-root class="miniprogram_dist-index-index"><view class="container">
...
global['__wxRoute'] = 'miniprogram_dist/index/index'
const main = {
    /**
     * 渲染块
     * @param {Object} params
...
export default global['__wxComponents']['miniprogram_dist/index/index']
</script>
