                  ...
                  <view v-if="index - 1 <= j && j <= index + 1" :data-event="{ id: 'r24jGdwMML' }">
                    ...
                    >
                      <view class="c-card-title" :data-event="{ id: 'r24jGdwMML' }">
                        <!-- <view
                          class="c-flex c-card-tag c-bg-red"
                          v-if="
                            item.data.exts.sourceType == '1' || item.data.exts.sourceType == '2'
                          " :data-event="{id:'r24jGdwMML'}">
                          雨虹丨{{ item.data.orderNum }}
                        </view>
                        <view
                          class="c-flex c-card-tag"
                          style="background: #106cff"
                          v-else-if="
                            item.data.exts.sourceType == '3' || item.data.exts.sourceType == '4'
                          " :data-event="{id:'r24jGdwMML'}">
                          修链丨{{ item.data.orderNum }}
                        </view> -->
                        <view
                      ...
                      <view class="c-card-content" :data-event="{ id: 'r24jGdwMML' }">
                        ...
                        <view class="c-flex c-m-b-10" v-else :data-event="{ id: 'r24jGdwMML' }">
                          ...
                          >
                            <van-icon
                              name="phone"
                              style="display: inline; color: #106cff"
                            ></van-icon>
                          </view>
                        </view>
                        <view class="c-m-b-10" :data-event="{ id: 'r24jGdwMML' }">
