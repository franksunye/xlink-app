  ...
  <view class="call-records" @click.capture="track">
    <scroll-view scroll-y="true" @scrolltolower="scrollToLower" class="c-h-1">
      <view class="c-relative">
            ...
            <view style="padding-bottom: 5px">
              <view class="c-flex c-flex-between c-item-center" style="padding: 0 10px">
                ...
                <van-button
                  ...
                  size="mini"
                  round
                  custom-style="color:#106cff;background-color:rgba(22, 93, 255, 0.10);border:none;padding-left:8px;padding-right:8px;display:flex;font-weight:bold;font-size:12px;"
                >
                  综合评分：{{ data.score }}
                </van-button>
              </view>
        ...
        <view
          @click="open('/subpackages2/callRecord/callRecordEval')"
          style="position: absolute; bottom: 5px; right: 28px; font-size: 14px; color: #106cff"
        >
          c
        </view>
      </view>
        ...
        <view style="margin-top: 8px" class="c-flex c-flex-between c-item-center">
          ...
          <view>
            <van-button
              ...
              icon="play-circle-o"
              size="small"
              custom-style="color:#106cff;background-color:rgba(22, 93, 255, 0.10);border:none;"
            ...
            <van-button
              ...
              icon="orders-o"
              size="small"
              custom-style="color:#106cff;background-color:rgba(22, 93, 255, 0.10);border:none;margin-left:16px"
      ...
      common.osg.ajax(
        'stat/aggr/speechText',
        {
          aggr: JSON.stringify([
            ...
            {
              $lookup: {
                from: 'frm_1340835581184723420_AiSpeechEval',
                let: { sid: '$serviceAppointmentId' },
                pipeline: [
                  {
