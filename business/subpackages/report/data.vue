  ...
  <view class="data" @click.capture="track">
    ...
    <view class="card">
      ...
      <block v-if="type == 'growth'">
        <!-- 内勤 -->
        <view class="content" v-if="currentRoleId == '7100212906800336051'">
          <view>
            <text class="label">工单数</text>
            <text class="value">
              {{ formData.saCount || '' }}
        ...
        <!-- 管家 -->
        <view class="content" v-if="currentRoleId == '8050029062726074247'">
          <view>
        ...
        <!-- 工队 -->
        <view class="content" v-if="currentRoleId == '5424993602217461538'">
          <view>
            <text class="label">进场数</text>
            <text class="value">
              {{ formData.approach || '' }}
...
export default {
  ...
  onLoad(params) {
    ...
    if (this.type == 'growth') {
      ...
      // 管家 查看合同额、合同数、客单价
      if (currentRole._id == '8050029062726074247') {
        this.url = 'basic/growth/contractStatistics';
      }
      // 工队 查看进场数、交付验收数、完工数
      if (currentRole._id == '5424993602217461538') {
