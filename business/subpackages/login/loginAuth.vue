<template>
  <view class="login" @click.capture="track">
    <view class="c-text-center">
      <image
        style="width: 70%"
        src="https://pub.fsgo365.cn/logo_b_login.png"
        mode="widthFix"
      ></image>
    </view>
    <van-field
    ...
    <view class="c-flex c-flex-center">
      ...
      >
        <view style="width: 50px; height: 50px; margin: 0 auto" :data-event="{ id: 'ynNkgWLV_m' }">
          <image
    ...
    login() {
      ...
      common.osg.ajax(
        ...
        res => {
          ...
          // 获取并更新管家定位
          // if (res.data.currentRole._id == '8050029062726074247') {
