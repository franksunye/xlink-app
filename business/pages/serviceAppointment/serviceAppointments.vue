        ...
        <block v-if="index - 1 <= j && j <= index + 1 && list[j]">
          ...
          >
            <view class="card-view c-flex c-flex-between">
              <view class="c-flex">
                <view
                  ...
                  :class="
                    ['1', '2', '5'].includes(item.data.exts.sourceType) ? 'c-bg-red' : 'c-bg-blue'
                  "
                >
                  <image
                    :src="
            ...
            >
              ...
              >
                <van-icon name="label-o" color="#106cff" style="margin-right: 8px" />
            ...
            <view v-if="buttonGroupShow(item)" class="card-view card-buttons">
              ...
              <!--              <van-button-->
              <!--                v-if="currentRole._id == '7100212906800336051' && item.data.exts.pwGroupBind != '1'"-->
              <!--                plain-->
              <!--                icon="wechat"-->
              <!--                block-->
              <!--                class="c-flex-1"-->
          ...
          <view>
            ...
            <view class="address-info">
              <view class="c-flex c-item-center">
                <!-- <van-icon name="location-o" size="20px" color="#106cff" class="c-m-r-20" /> -->
                <view>
              ...
              >
                <view class="c-flex">
                  ...
                  <view class="c-flex c-flex-center c-flex-1">
                    <!-- <van-icon name="underway-o" size="20px" color="#106cff" class="c-m-r-20" /> -->
                    <view>
