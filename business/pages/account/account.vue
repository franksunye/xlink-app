<template>
  <view class="account" @click.capture="track">
    <!-- <FloatingBall
      ref="childRef"
      :moveLeft="moveLeft"
      :moveTop="moveTop"
      ...
      <block v-if="isLogined">
        ...
        <view class="user-view">
          ...
          <view class="c-flex">
            ...
            <block v-if="currentRole._id == '7100212906800336051' && partnerSR._id">
              <van-button
              ...
              <van-button
                ...
                round
                :type="
                  partnerSR.workType == 0 ? 'primary' : partnerSR.workType == -1 ? 'danger' : ''
                "
                size="mini"
                class="c-m-l-20"
            ...
            <van-button
              v-if="currentRole._id == '829896304553774967'"
              icon="sort"
              :type="labour.status === 0 ? 'primary' : labour.status == 1 ? 'warning' : ''"
              size="mini"
              custom-style="padding:0 5px;"
              class="c-m-l-20"
    ...
    <!-- 服务商内勤、访客、试用用户、修链平台管理员 -->
    <view
      class="c-grid"
      v-if="
        currentRole._id == '7100212906800336051' ||
        currentRole._id == '2416398289453955348' ||
        currentRole._id == '4742147504330067121' ||
        currentRole._id == '2449148386138867771'
      "
    >
      ...
      <van-grid :border="false" square clickable icon-size="32px">
        <van-grid-item
          text="已创建"
          icon="https://pub.fsgo365.cn/yichuangjian.png"
        ...
        <van-grid-item
          text="已接单"
          icon="https://pub.fsgo365.cn/yijiedan.png"
          link-type="navigateTo"
        ...
        <van-grid-item
          text="已签收"
          icon="https://pub.fsgo365.cn/yiqianshou.png"
          link-type="navigateTo"
    ...
    <!-- 6284006356232419567小微服务站管理人员id  5947016148116027190社区门店推广专员-->
    <view
      class="c-grid"
      v-if="
        currentRole._id == '7100212906800336051' ||
        currentRole._id == '2416398289453955348' ||
        currentRole._id == '4742147504330067121' ||
        currentRole._id == '829896304553774967' ||
        currentRole._id == '8050029062726074247' ||
        currentRole._id == '6284006356232419567' ||
        currentRole._id == '5947016148116027190' ||
    ...
    >
      ...
      <van-grid :border="false" square clickable custom-class="c-grid">
        ...
        />
        <van-grid-item
          v-if="currentRole._id == '7100212906800336051'"
          text="账号管理"
          icon="friends"
          icon-color="#106cff"
          icon-class="c-blue"
        ...
        <van-grid-item
          v-if="currentRole._id == '8050029062726074247'"
          text="服务区域"
          icon="location"
          icon-color="#106cff"
          icon-class="c-blue"
        ...
        <van-grid-item
          v-if="
            currentRole._id == '7100212906800336051' || currentRole._id == '8050029062726074247'
          "
          text="资源分布图"
          icon="map-marked"
          icon-color="#106cff"
        ...
        <van-grid-item
          v-if="
            currentRole._id == '2416398289453955348' ||
            currentRole._id == '2241446122050009538' ||
            currentRole._id == '7100212906800336051'
          "
          text="信用账户"
          icon="card"
        ...
        <van-grid-item
          v-if="
            currentRole._id == '6284006356232419567' || currentRole._id == '5947016148116027190'
          "
          text="渠道绑定"
          icon="scan"
          icon-color="#106cff"
...
export default {
  ...
  onShow: function (params) {
    ...
    if (!common.osg.isLogined()) {
      ...
      // 合伙人内勤
      if (this.currentRole._id == '7100212906800336051' && !this.partnerSR._id) {
        this.getPartnerSR();
      }
      // 云用工工人
    ...
    getCurrentRoleFunctions(currentRole) {
      common.osg.ajax(
        ...
        res => {
          ...
          // 获取/更新伙伴服务资源状态
          if (currentRole._id == '7100212906800336051') {
            this.getPartnerSR();
          }
          // 更新技师服务资源状态
          this.getServiceResource();
