<template>
  <view class="products">
    ...
    <view
      ...
      style="padding: 10px"
    >
      <van-button type="info" size="small" round @click="shelfMaterials">上架</van-button>
    </view>
    <view
      v-if="activeTab == 'procedure'"
      class="c-flex c-flex-between c-item-center c-bg-white"
      style="padding: 10px"
    >
      <van-button type="info" size="small" round @click="shelfProcedures">上架</van-button>
    </view>
    <view
      v-if="activeTab == 'measure'"
      class="c-flex c-flex-between c-item-center c-bg-white"
      style="padding: 10px"
    >
      <van-button type="info" size="small" round @click="shelfMeasures">上架</van-button>
    </view>
    <view
      v-if="activeTab == 'projPackage'"
      class="c-flex c-flex-between c-item-center c-bg-white"
      style="padding: 10px"
    >
      <van-button type="info" size="small" round @click="shelfProjPackages">上架</van-button>
    </view>
    <!-- 展示材料介绍  -->
    <van-dialog
...
export default {
  ...
  methods: {
    ...
    getProjPackages() {
      common.osg.ajax(
        'basic/projPackage/queryWithRank',
        {
          _all: '1',
          'is:state|integer#and': 1,
          'is:approveState|integer#and': 1,
