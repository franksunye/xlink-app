          ...
          <van-dropdown-menu active-color="#ee0a24">
            ...
            >
              ...
              <view class="c-flex c-flex-around c-p-20">
                <van-button round plain @click="filterSortingShow = false">关闭</van-button>
                <van-button
                  round
                  plain
                  @click="
                ...
                <van-button round type="info" @click="application">应用</van-button>
              </view>
            </van-dropdown-item>
            <van-dropdown-item
              ...
              <view v-if="index - 1 <= j && j <= index + 1">
                ...
                >
                  ...
                  <view class="c-card-content">
                    ...
                    <view v-if="item.data.exts.type">
                      <text>
                        工单类型：{{ codelabel('select', 'workOrderType', item.data.exts.type) }}
                      </text>
                    </view>
                    <view v-if="item.data.memo">
                      <text>备注信息：{{ item.data.memo || '' }}</text>
                    </view>
                  </view>
                  <view
                    v-if="
