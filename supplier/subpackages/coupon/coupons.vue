<template>
  <view id="coupons-wrapper">
    <view v-for="(item, index) in list" :key="index" @click="showQrcode" :data-code="item.code">
      <view class="coupons-card" v-if="item.type == '99' && item.status != '3'">
        <view class="card-left overdue-bg">
          <view class="sawtooth">
            <view></view>
            <view></view>
            <view></view>
          ...
          <view style="font-size: 84rpx; margin-left: 8rpx">兑</view>
        </view>
        <view class="card-right">
          <view class="card-right-title">
            <view class="title-icon ticket-bg">兑奖券</view>
            <view class="title-text">{{ item.title }}</view>
            <view class="title-state overdue-title" v-if="item.status">
      ...
      <view class="coupons-card" v-if="item.type == '99' && item.status == '3'">
        <view class="card-left overdue-line-bg">
          <view class="sawtooth">
            <view></view>
            <view></view>
            <view></view>
        ...
        <view class="card-right">
          <view class="card-right-title">
            <view class="title-icon ticket-bg">兑奖券</view>
            <view class="title-text">{{ item.title }}</view>
            <view class="title-state" v-if="item.status">
              {{ codelabel('couponState', item.status) }}
            </view>
          </view>
          <view>
    ...
    <van-dialog use-slot :title="content" :show="qrcodeShow" @confirm="closeQrcode">
