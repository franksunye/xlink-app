<template>
  <view class="index" @click.capture="track">
    ...
    >
      ...
      <text v-else :class="!isLogined ? 'c-gray-8' : ''">吉柿修房服务商</text>
    </view>
    <view>
      <!-- 轮播图 -->
      <swiper
      ...
      <image
        v-else-if="isLogined"
        src="https://pub.fsgo365.cn/jishi/banner_b.png"
        mode="widthFix"
        class="c-w-1"
      ></image>
      <!-- 公告 -->
      ...
      <!-- 管家驾驶舱 -->
      <!-- 关键经营指标 -->
      <view class="housekeepReport" v-if="isLogined && currentRole._id == '3481370558631265818'">
      ...
      <!-- 关键待做事宜统计 -->
      <view class="housekeepReport2" v-if="isLogined && currentRole._id == '3481370558631265818'">
      ...
      <!-- 功能导航 -->
      <van-grid v-if="functionList.length > 0" :border="false" clickable column-num="3">
        <block v-for="(item, index) in functionList" :key="index">
          <van-grid-item
            ...
            :url="
              item.name == '成长通' && currentRole._id == '3481370558631265818'
      ...
      <van-image
        ...
        fit="widthFix"
        src="https://pub.fsgo365.cn/jishi/banner-bottom.png"
        @click="toNotice({ _id: '5593867496617953487' })"
...
export default {
  ...
  async onShow() {
    ...
    if (!common.osg.isLogined()) {
      ...
      // 管家 独有功能
      if (this.currentRole._id == '3481370558631265818') {
  ...
  methods: {
    ...
    reportNavigateTo(val) {
      // 待预约
      if (val == '105') {
        app.globalData.funcId = '2132685213334876191';
        this.doOpen('/pages/serviceAppointment/serviceAppointments', {}, { mode: 'switchTab' });
      }
      // 待上门
      if (val == '202') {
        app.globalData.funcId = '1697109450139913281';
        this.doOpen('/pages/serviceAppointment/serviceAppointments', {}, { mode: 'switchTab' });
      }
      // 待下单
      if (val == '203') {
        app.globalData.funcId = '6732664253238755839';
        this.doOpen('/pages/serviceAppointment/serviceAppointments', {}, { mode: 'switchTab' });
      }
      // 待签约
      if (val == '206') {
        app.globalData.funcId = '2290590054233387349';
        this.doOpen('/pages/serviceAppointment/serviceAppointments', {}, { mode: 'switchTab' });
      }
      // 不需要上门
      if (val == '201') {
        app.globalData.funcId = '675191852432770842';
        this.doOpen('/pages/serviceAppointment/serviceAppointments', {}, { mode: 'switchTab' });
      }
      // 上门未成交
      if (val == '204') {
        app.globalData.funcId = '8283409301596358326';
        this.doOpen('/pages/serviceAppointment/serviceAppointments', {}, { mode: 'switchTab' });
      }
    },
