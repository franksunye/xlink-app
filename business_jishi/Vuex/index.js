    ...
    tabbarList: [
      {
        ...
        selectedIconPath: '/static/images/tabBar/shouye-o.png'
      },
      {
        pagePath: 'pages/account/account',
        text: '我的',
        iconPath: '/static/images/tabBar/wode.png',
        selectedIconPath: '/static/images/tabBar/wode-o.png'
      }
    ] //根据角色变化tabbar 导航栏
  },
  mutations: {
    ...
    updatTabbarList(state) {
      ...
      const defaultTabbarList = [
        {
          pagePath: 'pages/index/index',
          text: '首页',
          iconPath: '/static/images/tabBar/shouye-o.png',
          selectedIconPath: '/static/images/tabBar/shouye.png'
        },
        {
          pagePath: 'pages/account/account',
          text: '我的',
          iconPath: '/static/images/tabBar/wode-o.png',
      ...
      // TODO:“项目”入口当前只给指定服务商开放，临时判断组织id
      // let user = wx.getStorageSync('user');
      // if (cloudStoreItem && cloudStoreItem.functionList) {
      //   cloudStoreItem.functionList = cloudStoreItem.functionList.filter(item =>
      //     item.action == 'pages/project/projects'
      //       ? [
      //           '4168458814819356292',
      //           '8215492209623871688',
      //           '5947701159822997941',
