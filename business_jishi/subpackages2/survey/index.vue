    ...
    <view class="toolsBottom">
      ...
      <view>
        ...
        <image
          ...
          style="background: #ff6900; padding: 5px 7px"
        />
      </view>
      <!-- 开始/暂停 -->
      <view>
        <image
          ...
          style="width: 140rpx; height: 140rpx; padding: 10px 6px 10px 14px; background: #ff6900"
        />
        <image
          v-else
          @tap="doBtn('start')"
          ...
          style="width: 140rpx; height: 140rpx; background: #ff6900"
        />
      </view>
      <!-- 设置 -->
      <view>
        ...
        <image
          ...
          style="background: #ff6900; padding: 0"
        />
      </view>
      <!-- 调试 -->
      <view>
        ...
        <image
          ...
          style="background: #ff6900; padding: 10px"
        />
      </view>
    </view>
