...
export default {
  ...
  methods: {
    ...
    getAmapUrl(startPoint, nextPoint, wayPoints) {
      ...
      if (this.systemInfo.osName == 'ios') {
        url = 'iosamap://path?sourceApplication=吉柿修房&';
      } else {
        url = 'androidamap://route?sourceApplication=吉柿修房&';
      }
    ...
    getBaiduMapUrl(startPoint, endPoint, wayPoints) {
      ...
      // 导航模式：驾车导航，gcj02坐标系
      url += '&mode=driving&coord_type=gcj02&src=ios.Xiulian.吉柿修房';
