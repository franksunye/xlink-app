<template>
  <view class="inspectionAppointment c-box" :class="openForm ? 'c-hidden c-h-50rpx' : ''">
                ...
                >
                  <view
                    v-if="
                      ...
                      activeTab.detail.name.nodeDef.formDefId == '266342151050117958'
                    "
              ...
              <block v-else-if="extField.type == 'file'">
                ...
                >
                  ...
                  <view
                    ...
                    class="c-flex"
                  >
                    <van-icon name="edit" color="#ff6900" class="c-m-r-10" />
    ...
    <van-popup
      ...
      custom-style="z-index:100"
    >
      <view style="padding: 14px 10px 5px; text-align: center; font-weight: 600">吉柿修房</view>
      <!-- #ifdef MP-WEIXIN -->
  ...
  methods: {
      ...
      common.osg.ajax(
        ...
        res => {
          ...
          if (
            ...
            this.activeTab.detail.name &&
            this.activeTab.detail.name.nodeDef &&
            this.activeTab.detail.name.nodeDef.formDefId == '266342151050117958'
          ) {
            // 不查询列表，tabChange会查询
    ...
    getSurveyPDFUrl() {
      return new Promise(resolve => {
        common.osg.ajax(
          'biz/extForm/query/266342151050117958',
          {
            sortField: 'createTime',
            sortOrder: 'desc',
