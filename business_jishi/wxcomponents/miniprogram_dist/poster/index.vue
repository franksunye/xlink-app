<template>
<uni-shadow-root class="miniprogram_dist-poster-index"><view @click="onCreate">
    <slot></slot>
</view>
...
global['__wxRoute'] = 'miniprogram_dist/poster/index'
Component({
    properties: {
        config: {
            type: Object,
...
export default global['__wxComponents']['miniprogram_dist/poster/index']
</script>
