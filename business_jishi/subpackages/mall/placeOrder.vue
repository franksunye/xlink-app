<template>
  <view class="placeOrder" @click.capture="track">
      ...
      <view v-if="address._id" class="c-flex-1" :data-event="{ id: 'xQ3DcTCy-9' }">
        ...
        >
          ...
          <van-button
            ...
            size="mini"
            color="#E5EFFB"
            custom-style="color:#ff6900;font-size:10px;height: 15px;line-height: 15px;min-width: 35px;display:flex;"
            :data-event="{ id: 'xQ3DcTCy-9' }"
          >
            默认
          </van-button>
            ...
            <view>
              ...
              <view>
                <text
                  ...
                  class="desc-tag"
                  style="border: 1px solid #ff6900; color: #fff; background-color: #ff6900"
                >
                  赠品
                </text>
              ...
              <text class="desc-tag" v-if="item.exts.brand">品牌：{{ item.exts.brand || '' }}</text> -->
                ...
                v-if="item.desc"
                @click="openMaterialDetail(item.name, item.desc)"
                style="border: 1px solid #ff6900; color: #ff6900" :data-event="{id:'KlfQUhsWtc'}">
                材料介绍
              </text> -->
              </view>
            </view>
    ...
    <view class="voucher">
      <van-tabs wrap-class="c-tabs-wrap" color="#ff6900" title-active-color="#ff6900">
