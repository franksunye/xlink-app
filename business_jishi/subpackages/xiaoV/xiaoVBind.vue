  ...
  <view class="xiaoVBind" @click.capture="track">
    <van-cell-group>
      ...
      >
        <van-icon
          slot="right-icon"
          :color="verificationState ? '#07c160' : '#ff6900'"
          :style="'color:' + (verificationState ? '#07c160' : '#ff6900')"
          :name="verificationState ? 'checked' : 'scan'"
        />
      </van-field>
      <van-cell
        v-if="currentRole._id == '2358903041435846552'"
        title="绑定服务商"
        is-link
        required
...
export default {
  ...
  methods: {
    ...
    activityBind() {
      ...
      if (this.currentRole._id == '2358903041435846552' && !this.formData.bindOrgId) {
      ...
      if (this.currentRole._id == '2358903041435846552') {
        this.formData.promoterLevel = '4';
      }
      if (this.currentRole._id == '9001474127894983394') {
