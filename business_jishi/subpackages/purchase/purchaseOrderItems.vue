      ...
      <view style="padding-bottom: 50px">
        <view style="margin: 20rpx" v-for="(newListItem, j) in newList" :key="j">
          ...
          <view class="c-card" v-for="(item, k) in newListItem" :key="k" :data-id="item._id">
            ...
            <!-- currentRole_id == '3025142616514869963' 平台管理员 -->
            <view class="c-m-t-20">
              <view
                v-if="item.status !== '499' && item.status !== '498'"
              ...
              <view class="c-flex c-flex-end">
                ...
                <view
                  class="dispatchBtn"
                  v-if="item.status == '101' && currentRole_id == '3025142616514869963'"
                >
                  <van-button
                    plain
                    round
                ...
                <view
                  class="dispatchBtn"
                  v-if="item.status == '102' && currentRole_id == '3025142616514869963'"
                >
                  <van-button
                    plain
                    round
                ...
                <view
                  class="dispatchBtn"
                  v-if="item.status == '201' && currentRole_id == '3025142616514869963'"
                >
                  <van-button
                    plain
                    round
...
export default {
  data() {
    return {
      ...
      currentRole_id: '', //当前登陆人的ID  currentRole_id == '3025142616514869963' 伙伴服务商平台管理员ID
      //签收上传图片
      signFor: {
        show: false,
        list: []
