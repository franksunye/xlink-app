  ...
  >
    ...
    <view class="c-card c-m-b-0" v-if="!canvas.canvasSignatureDataShow">
      <view class="c-card-title">
        ...
        >
          <view class="c-card-tag-title c-bg-jishi" :data-event="{ id: 't7oxFDXyWj' }">雨虹</view>
        ...
        >
          <view class="c-card-tag-title c-bg-jishi" :data-event="{ id: 'floPujOG4n' }">吉柿</view>
          <view class="c-card-tag-info c-jishi c-border-jishi" :data-event="{ id: 'floPujOG4n' }">
                ...
                <van-tab title="订单" name="order">
                  ...
                  >
                    ...
                    >
                      ...
                      <block v-if="item.processState == '0'">
                        ...
                        <!-- 4.27修改信息来源 3自有单、4吉柿平台单 的时候不展示电子签约 -->
                        <van-button
                          v-if="item.exts.isAgain != 1 && isHandler"
                          type="info"
                          size="small"
                ...
                <van-tab title="合同" name="contract">
                  ...
                  >
                    ...
                    <view class="c-card-footer c-m-t-20" :data-event="{ id: 'wGt7JJ-MTa' }">
                      ...
                      <!-- 547903794062802873 核查人员角色ID -->
                      <view
                        v-if="
                          roleId == '547903794062802873' &&
                          (item.exts.contractStatus == 10 || item.exts.contractStatus == -2)
                        "
                ...
                <block v-for="(subflow, index1) in subflows" :key="index1">
                  ...
                  >
                    ...
                    <view
                      ...
                      v-if="subflow.defId == '1916876999445529015'"
                      :data-event="{ id: 'I2q-kme8RL' }"
                    >
                ...
                >
                  <view
                    v-if="
                      ...
                      activeTab.detail.name.nodeDef.formDefId == '2960554871510251003'
                    "
                  ...
                  <view class="c-card-content" :data-event="{ id: 'I2q-kme8RL' }">
                    ...
                    <view
                      v-else-if="
                        ...
                        activeTab.detail.name &&
                        activeTab.detail.name.nodeDef &&
                        activeTab.detail.name.nodeDef.formDefId == '9105866072745948842'
                      "
                      class="c-card-content-item"
                      :data-event="{ id: 'I2q-kme8RL' }"
                    >
            ...
            <block v-for="(item, index) in log.data" :key="index">
              ...
              >
                ...
                >
                  ...
                  <view
                    v-if="item.type == 1 && item.mediaContent && item.mediaContent.length > 0"
                    class="c-m-t-10"
                  >
                    <van-uploader
                      :file-list="item.mediaContent"
                      :max-count="item.mediaContent.length"
                      :deletable="false"
                    />
                  </view>
                </view>
    ...
    >
      ...
      <van-button
        v-if="
          activeTab.detail.name.nodeDef.formDefId == '8675820106849042193' &&
            ...
            <view class="c-card-footer c-flex-between">
              <view>
                <van-button
                  ...
                  size="small"
                  v-if="
                    (subNode.formDefId == '4111671741587344175' ||
                      subNode.formDefId == '3060799877209410135') &&
                    subNode.formDataId &&
      ...
      <movable-area style="height: 100%; width: 100%">
        ...
        >
          <view
            v-if="
              currentNode.nodeDef &&
              currentNode.nodeDef.formDefId != '4111671741587344175' &&
              currentNode.nodeDef.formDefId != '3060799877209410135' &&
              (currentNode.state == 0 ||
                (addFormBtn &&
                  activeTab.detail.name.nodeDef &&
                  (activeTab.detail.name.nodeDef.nodeType == 'forms' ||
          ...
          >
            ...
            <van-button
              ...
              v-else-if="
                ...
                currentNode.nodeDef.nodeType != 'disable' &&
                currentNode.visible &&
                (currentNode.formDefId == '4111671741587344175' ||
                  currentNode.formDefId == '3060799877209410135') &&
                activeTab.detail &&
                activeTab.detail.name &&
                activeTab.detail.name.state == 0
              "
  ...
  methods: {
            ...
            res => {
              ...
              if (defId == '16398693346985987158') {
                let arr = runNodes.filter(
                  node =>
                    node.state != -1 &&
                    (node.formDefId == '4111671741587344175' ||
                      node.formDefId == '3060799877209410135') &&
                    node.formDataId
                );
                if (arr.length > 0) {
      ...
      common.osg.ajax(
        ...
        data => {
          ...
          if (data.success) {
            ...
            // this.getNodeFormData('4111671741587344175', acceptanceId, formData => {
    ...
    getFormData(formDefId, formDataId, edit, node) {
      ...
      let params = {
        ...
        notFilterBelongTo:
          formDefId == '4111671741587344175' || formDefId == '3060799877209410135' ? '1' : null // 施工验收单是多人可填写，不过滤数据权限
      };
      if (formDefId == '4111671741587344175') {
      ...
      common.osg.ajax(
        ...
        res => {
          ...
          // TODO 施工验收单 默认赋值
          if (formDefId == '4111671741587344175' || formDefId == '3060799877209410135') {
            // 服务人员
    ...
    saveForm(type) {
      ...
      if (
        (nodeFormDefId == '4111671741587344175' || nodeFormDefId == '3060799877209410135') &&
        params._id
      ) {
        // 校验工序步骤是否必填
        if (type != 'saveOnly') {
            ...
            common.osg.ajax(
              ...
              res => {
                ...
                if (
                  ...
                  this.activeTab.detail.name &&
                  this.activeTab.detail.name.nodeDef &&
                  this.activeTab.detail.name.nodeDef.formDefId == '2960554871510251003'
                ) {
                  // 不查询列表，tabChange会查询
                ...
                if (nodeFormDefId == '8675820106849042193' && this.formData.need == '1') {
                  // #ifdef MP-WEIXIN
                  let address =
    ...
    signFormSubmit(type) {
      ...
      formData.type = 1; // 补充签约信息时将报价单转为订单
    ...
    openDeliveryOrder(orderId) {
      common.osg.open('../webView/webView', {
        href: `${common.osg.host}/h5/#/subpackages/order/deliveryOrder?orderId=${orderId}&tenantId=4670873342363649607`
      });
    },
    // 复制到剪切板
    copy(data, msg) {
    ...
    getSurveyPDFUrl() {
      return new Promise(resolve => {
        common.osg.ajax(
          'biz/extForm/query/2960554871510251003',
          {
            sortField: 'createTime',
            sortOrder: 'desc',
    ...
    getOrderInspectionRepor() {
      ...
      common.osg.ajax(
        'biz/extForm/query/4111671741587344175',
        params,
        res => {
          res.data.map(item => {
    ...
    getHeadman() {
      ...
      common.osg.ajax(
        'user/query',
        {
          ...
          'in:roleIds|array#and': '1259263938717893739',
          sortField: 'createTime',
          sortOrder: 'asc',
          notFilterBelongTo: '1',
          notFilterOrgId: '1'
