...
export default {
  ...
  methods: {
    ...
    submit() {
      ...
      //赋值工单的信息渠道 3481370558631265818管家    6631748470755706348内勤  1259263938717893739工队
      // 只有当前登录人是管家、内勤、工队才会给channel赋值
      if (
        currentRole == '3481370558631265818' ||
        currentRole == '6631748470755706348' ||
        currentRole == '1259263938717893739'
      ) {
        ...
        // }
        if (currentRole == '6631748470755706348') {
          // 如果有合伙人内勤则信息渠道为
          this.formData.channel = ['46', '4610', '4610070'];
        } else if (currentRole == '3481370558631265818') {
          //如果有管家角色信息渠道则为
          this.formData.channel = ['46', '4610', '4610080'];
        } else if (currentRole == '1259263938717893739') {
          //如果有工队角色信息渠道则为
          this.formData.channel = ['46', '4610', '4610060'];
        }
      }
    ...
    getMyServiceType() {
      ...
      if (
        this.user.orgId == '0' ||
        this.user.orgId == '4670873342363649607' ||
