...
export default {
  data() {
    return {
      serviceType: '',
      currentRoleType: '', // 0管家:3481370558631265818 1工队:1259263938717893739 2内勤:6631748470755706348
      options: {
  ...
  onLoad(params) {
    ...
    switch (currentRoleId) {
      case '3481370558631265818': // 管家
        this.currentRoleType = '0';
        break;
      case '1259263938717893739': // 工队
        this.currentRoleType = '1';
        break;
      case '6631748470755706348': // 内勤
