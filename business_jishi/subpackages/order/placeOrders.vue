  ...
  >
    <movable-area style="height: 100%; width: 100%">
        ...
        >
          <view class="c-flex-1" style="margin-right: 5px" :data-event="{ id: '7p0_WkVkhm' }">
            <van-button
              type="default"
              icon="plus"
              custom-style="border-radius:8px;width:100%;color:#ff6900"
              @click="addItem"
      ...
      <van-submit-bar
        ...
        v-if="!loading && type == '0' && entry == 'quote'"
...
export default {
  ...
  methods: {
    ...
    initData() {
      ...
      this.entry = common.osg.param('entry');
      if (this.type == '0' && this.entry == 'quote') {
