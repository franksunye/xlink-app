<template>
  <view class="storeMenu" @click.capture="track">
    ...
    <!-- #endif -->
    <!-- 指标块 -->
    <view v-if="currentRole._id == '3481370558631265818'" class="housekeepReport">
    ...
    <!-- 功能导航 -->
    <view v-if="currentRole._id == '6631748470755706348'">
      <view class="c-card">
        <van-grid
      ...
      <view v-if="currentRole._id == '6631748470755706348'" class="c-card">
        <van-cell
          :border="false"
          icon="https://pub.fsgo365.cn/jishi/dianpuzhuangxiu.png"
          is-link
          title="店铺装修"
        ...
        <van-cell
          :border="false"
          icon="https://pub.fsgo365.cn/jishi/qudaomaguanli.png"
          is-link
          title="渠道码管理"
          link-type="navigateTo"
